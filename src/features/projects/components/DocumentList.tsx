            ...
            >
              <div>
                ...
                <div className="text-sm text-gray-600">
                  {doc.progress}% Annotated
                </div>
              </div>
              <UIButton
                label="Continue"
                onClick={() => console.log(`Continue ${doc.name}`)}
              />
            </div>
          ))}
        </div>
          ...
          {openDocs.map((doc) => (
            ...
            >
              ...
              <div className="flex gap-4">
                <UIButton
                  label="Preview"
                  onClick={() => handlePreviewDocument(doc.content)}
                />
                <button
                ...
                <UIButton
                  label="Start Working"
                  onClick={() => console.log(`Start Working ${doc.name}`)}
                />
              </div>
            </div>
          ))}
        ...
        <div className="space-y-4">
          {completedDocs.map((doc) => (
            ...
            >
              ...
              <UIButton
                label="View"
                onClick={() => console.log(`View ${doc.name}`)}
              />
            </div>
          ))}
        </div>
